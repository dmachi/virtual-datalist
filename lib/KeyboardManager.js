dojo.provide("dojoc.dmachi.virtual.KeyboardManager");
dojo.require("dojoc.dmachi.virtual.Component");

dojo.declare("dojoc.dmachi.virtual.KeyboardManager", dojoc.dmachi.virtual.Component, {
	constructor: function(params){
		...
		dojo.addOnLoad(dojo.hitch(this, function(){
			...
			//dojo.connect(dojo.doc, "onkeypress", this, "onKeyPress");
